...
Strongly colored Roman and Byzantine poly- chrome mosaics from the first millennium of the Christian era have been preserved in Europe. Mosaic art placed high demands on coloristic powers, because each color area is composed of numerous point elements, each requiring consider- ation and choice. The mosaic artists of Ravenna in the fifth and sixth centuries were able to produce many different effects with complementary colors. 
